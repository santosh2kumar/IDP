...
public class StreamingJob {
	...
	public static void main(String[] args) throws Exception {
		...
		kProperties.setProperty("bootstrap.servers", "kafka-svc:9093");
		kProperties.setProperty("zookeeper.connect", "zk-0.zk-svc.default.svc.cluster.local:2181,zk-1.zk-svc.default.svc.cluster.local:2181,zk-2.zk-svc.default.svc.cluster.local:2181");
			...
			.addSink(new CassandraTupleSink<Tuple2<String, String>>(
                                ...
                                new ClusterBuilder() {
                                        ...
                                        public Cluster buildCluster(Cluster.Builder builder) {
                                                return builder
                                                        .addContactPoint("cassandra").withPort(9042)
                                                        .build();
                                        }
                                }));
		...
		stream_with_aggregations
			.addSink(new CassandraTupleSink<Tuple5<String, String, String, Long, Double>>(
                                "INSERT INTO flinkresult.agg_events"
